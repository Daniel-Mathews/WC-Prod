      ...
      <div className={styles.page}>
        ...
        <main className={styles.main}>
          <div className={styles.hero}>
            <h1 className={styles.heroTitle}>Streamline Your Supply Chain with Wols Logistics</h1>
            <p className={styles.heroSubtitle}>Your trusted partner for end-to-end logistics and sales management. Fast, reliable, and data-driven.</p>
            
          </div>
        </main>
        <footer className={styles.footer}>
          <p>&copy; 2025 Wols Logistics. All Rights Reserved.</p>
        </footer>
      </div>
    </>
  );
